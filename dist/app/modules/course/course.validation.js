...
const createCourseValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        preRequisiteCourses: zod_1.z.array(preRequisiteCoursesValidationSchema).optional(),
        isDeleted: zod_1.z.boolean().optional(),
    })
});
...
const updateCourseValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        preRequisiteCourses: zod_1.z.array(updatePreRequisiteCoursesValidationSchema).optional(),
        isDeleted: zod_1.z.boolean().optional(),
    })
});
const facultiesWithCourseValidation = zod_1.z.object({
    body: zod_1.z.object({
